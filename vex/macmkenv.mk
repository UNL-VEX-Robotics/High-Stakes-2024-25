...
VEX_SDK_PATH ?= ${HOME}/.config/Code/User/globalStorage/vexrobotics.vexcode/sdk/cpp/V5/V5_20240223_11_00_00
...
CC      = clang
CXX     = clang
ARMTOOLS= ${HOME}/.config/Code/User/globalStorage/vexrobotics.vexcode/tools/cpp/toolchain_linux64/gcc/bin
OBJCOPY = ${ARMTOOLS}/arm-none-eabi-objcopy
SIZE    = ${ARMTOOLS}/arm-none-eabi-size
LINK    = ${ARMTOOLS}/arm-none-eabi-ld
ARCH    = ${ARMTOOLS}/arm-none-eabi-ar
ECHO    = @echo
DEFINES = -DVexV5
